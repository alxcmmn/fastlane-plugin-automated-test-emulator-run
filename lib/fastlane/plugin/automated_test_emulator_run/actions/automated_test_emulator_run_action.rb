      ...
      class AutomatedTestEmulatorRunAction < Action
        def self.run(params)
          ...
          begin
            ...
            unless callback_task.nil?
              UI.message("Using callback.".green)
              Dir.chdir("./fastlane")
              callback_task.call()
              Dir.chdir("..")
            end
        ...
        [
          ...
          FastlaneCore::ConfigItem.new(key: :shell_task,
                                       ...
                                       conflicting_options: [:gradle_task, :callback],
                                       is_string: true,
                                       optional: true),
          FastlaneCore::ConfigItem.new(key: :gradle_task,
                                       env_name: "GRADLE_TASK",
                                       description: "The gradle task you want to execute",
                                       conflicting_options: [:shell_command, :callback],
                                       is_string: true,
                                       optional: true),
          FastlaneCore::ConfigItem.new(key: :callback,
                                       env_name: "TEST_EMULATOR_CALLBACK",
                                       description: "The callback you want to execute",
                                       conflicting_options: [:gradle_task, :shell_command],
                                       type: Proc,
                                       optional: true),
